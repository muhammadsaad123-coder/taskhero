...
function page() {
    const cleaningItems = [
        { id: 1, image: cleaning, title: 'I will clean your house' },
        { id: 2, image: cleaning, title: 'I will clean your house' },
        { id: 3, image: cleaning, title: 'I will clean your house' },
        { id: 4, image: cleaning, title: 'I will clean your house' },
        { id: 5, image: cleaning, title: 'I will clean your house' },
                ...
                <div className='flex justify-center flex-wrap-reverse md:flex-nowrap '>
                    <div >
                        <div className="p-4 pb-2  md:pr-0   ">
                            ...
                            <CleaningCard
                                title="I will clean your house"
                                items={cleaningItems}
                                onFavoriteClick={() => alert('Added to favorites!')}
                            />
                        </div>
                        <div className="pt-0 p-4 md:pr-0   bg-gray-100 flex items-center justify-center ">
                            <About
                        ...
                        <div className=" pb-2 p-4 pt-2 md:pr-0  flex items-center justify-center">
